                ...
                <Flex>
                    ...
                    <form>
                        <div className='subscribe__input'>
                            ...
                            <Input type="email" id="emailToSubscription" name="emailToSubscription" placeholder="Email" width="274px" height="40px" />
                            <Button bgColor="#0D6EFD" color="#fff" width="110px" height="40px">Subscribe</Button>
                        </div>
                    </form>
                </Flex>
            </Container>
